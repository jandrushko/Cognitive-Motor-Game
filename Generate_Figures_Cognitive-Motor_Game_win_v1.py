    ...
    for idx, file_path in enumerate(group_files):
        ...
        if 'congruent_coords' in file_path:
            ...
            if 'phase-start' in file_path:
                # print("Detected phase-start")  # Debug print
                ...
                # print("Detected phase-deliver")  # Debug print
...
# Set the root directory to the 'rawdata' directory within the current working directory
root_directory = os.path.join(os.getcwd(), 'rawdata')
...
for directory in sub_dirs:
    ...
    for group_name, group_files in groups.items():
        # print(f"Processing group: {group_name}")  # Debug print
